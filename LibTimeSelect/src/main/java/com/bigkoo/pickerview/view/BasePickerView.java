...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            ...
            //设置对话框 默认左右间距屏幕30
            params.leftMargin = pt2px(15F);
            params.rightMargin = pt2px(15F);
    ...
    public static int pt2px(float value) {
        return (int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PT, value, Resources.getSystem().getDisplayMetrics()) + 0.5f);
    }
