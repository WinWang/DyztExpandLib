...
public class PickerOptions {
    ...
    public int textColorOut = 0x99333333; //分割线以外的文字颜色
    public int textColorCenter = 0xFF333333; //分割线之间的文字颜色
    public int dividerColor = 0xFFE5E5E5; //分割线的颜色
    ...
    public boolean isAlphaGradient = true; //透明度渐变
}
