...
public class FloatWindow {
    ...
    public static class B {
        ...
        public B setCustomTouchListener(boolean customTouchListener) {
    ...
    public static void unRegisterReceiver(Context applicationContext) {
        try {
            if (floatLifecycle != null) {
                floatLifecycle.unRegisterReceiver(applicationContext);
            }
        } catch (Exception e) {
